// Generated from src/parser/grammars/csharp/CSharpPreprocessorParser.g4 by ANTLR 4.9.0-SNAPSHOT
...
export class CSharpPreprocessorParserParser extends CSharpPreprocessorParserBase {
	...
	public static readonly VOCABULARY: Vocabulary = new VocabularyImpl(CSharpPreprocessorParserParser._LITERAL_NAMES, CSharpPreprocessorParserParser._SYMBOLIC_NAMES, []);

	// @Override
	// @NotNull
	public get vocabulary(): Vocabulary {
		return CSharpPreprocessorParserParser.VOCABULARY;
	}
	...
	// @Override
	public get ruleNames(): string[] { return CSharpPreprocessorParserParser.ruleNames; }

	// @Override
	public get serializedATN(): string { return CSharpPreprocessorParserParser._serializedATN; }
	...
	constructor(input: TokenStream) {
		super(input);
		this._interp = new ParserATNSimulator(CSharpPreprocessorParserParser._ATN, this);
	}
	// @RuleVersion(0)
	public preprocessor_directive(): Preprocessor_directiveContext {
		...
		this.enterRule(_localctx, 0, CSharpPreprocessorParserParser.RULE_preprocessor_directive);
		let _la: number;
		try {
			this.state = 80;
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case CSharpPreprocessorParserParser.DEFINE:
				_localctx = new PreprocessorDeclarationContext(_localctx);
				this.enterOuterAlt(_localctx, 1);
				{
				this.state = 6;
				this.match(CSharpPreprocessorParserParser.DEFINE);
				this.state = 7;
				this.match(CSharpPreprocessorParserParser.CONDITIONAL_SYMBOL);
				this.state = 8;
				this.directive_new_line_or_sharp();
				 this.OnPreprocessorDirectiveDefine(); 
				}
				break;
			case CSharpPreprocessorParserParser.UNDEF:
				_localctx = new PreprocessorDeclarationContext(_localctx);
				this.enterOuterAlt(_localctx, 2);
				{
				this.state = 11;
				this.match(CSharpPreprocessorParserParser.UNDEF);
				this.state = 12;
				this.match(CSharpPreprocessorParserParser.CONDITIONAL_SYMBOL);
				this.state = 13;
				this.directive_new_line_or_sharp();
				...
				break;
			case CSharpPreprocessorParserParser.IF:
				_localctx = new PreprocessorConditionalContext(_localctx);
				this.enterOuterAlt(_localctx, 3);
				{
				this.state = 16;
				this.match(CSharpPreprocessorParserParser.IF);
				this.state = 17;
				...
				break;
			case CSharpPreprocessorParserParser.ELIF:
				_localctx = new PreprocessorConditionalContext(_localctx);
				this.enterOuterAlt(_localctx, 4);
				{
				this.state = 21;
				this.match(CSharpPreprocessorParserParser.ELIF);
				this.state = 22;
				(_localctx as PreprocessorConditionalContext)._expr = this.preprocessor_expression(0);
				this.state = 23;
				this.directive_new_line_or_sharp();
				...
				break;
			case CSharpPreprocessorParserParser.ELSE:
				_localctx = new PreprocessorConditionalContext(_localctx);
				this.enterOuterAlt(_localctx, 5);
				{
				this.state = 26;
				this.match(CSharpPreprocessorParserParser.ELSE);
				this.state = 27;
				this.directive_new_line_or_sharp();
				 this.OnPreprocessorDirectiveElse(); 
				}
				break;
			case CSharpPreprocessorParserParser.ENDIF:
				_localctx = new PreprocessorConditionalContext(_localctx);
				this.enterOuterAlt(_localctx, 6);
				{
				this.state = 30;
				this.match(CSharpPreprocessorParserParser.ENDIF);
				this.state = 31;
				this.directive_new_line_or_sharp();
				 this.OnPreprocessorDirectiveEndif(); 
				}
				break;
			case CSharpPreprocessorParserParser.LINE:
				_localctx = new PreprocessorLineContext(_localctx);
				this.enterOuterAlt(_localctx, 7);
				{
				this.state = 34;
				this.match(CSharpPreprocessorParserParser.LINE);
				this.state = 41;
				this._errHandler.sync(this);
				switch (this._input.LA(1)) {
				case CSharpPreprocessorParserParser.DIGITS:
					{
					this.state = 35;
					this.match(CSharpPreprocessorParserParser.DIGITS);
					this.state = 37;
					this._errHandler.sync(this);
					_la = this._input.LA(1);
					if (_la === CSharpPreprocessorParserParser.STRING) {
						{
						this.state = 36;
						this.match(CSharpPreprocessorParserParser.STRING);
						}
					}

					}
					break;
				case CSharpPreprocessorParserParser.DEFAULT:
					{
					this.state = 39;
					this.match(CSharpPreprocessorParserParser.DEFAULT);
					}
					break;
				case CSharpPreprocessorParserParser.DIRECTIVE_HIDDEN:
					{
					this.state = 40;
					this.match(CSharpPreprocessorParserParser.DIRECTIVE_HIDDEN);
					}
					break;
				default:
				...
				break;
			case CSharpPreprocessorParserParser.ERROR:
				_localctx = new PreprocessorDiagnosticContext(_localctx);
				this.enterOuterAlt(_localctx, 8);
				{
				this.state = 46;
				this.match(CSharpPreprocessorParserParser.ERROR);
				this.state = 47;
				this.match(CSharpPreprocessorParserParser.TEXT);
				this.state = 48;
				this.directive_new_line_or_sharp();
				 this.OnPreprocessorDirectiveError(); 
				}
				break;
			case CSharpPreprocessorParserParser.WARNING:
				_localctx = new PreprocessorDiagnosticContext(_localctx);
				this.enterOuterAlt(_localctx, 9);
				{
				this.state = 51;
				this.match(CSharpPreprocessorParserParser.WARNING);
				this.state = 52;
				this.match(CSharpPreprocessorParserParser.TEXT);
				this.state = 53;
				this.directive_new_line_or_sharp();
				...
				break;
			case CSharpPreprocessorParserParser.REGION:
				_localctx = new PreprocessorRegionContext(_localctx);
				this.enterOuterAlt(_localctx, 10);
				{
				this.state = 56;
				this.match(CSharpPreprocessorParserParser.REGION);
				this.state = 58;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (_la === CSharpPreprocessorParserParser.TEXT) {
					{
					this.state = 57;
					this.match(CSharpPreprocessorParserParser.TEXT);
					}
				...
				break;
			case CSharpPreprocessorParserParser.ENDREGION:
				_localctx = new PreprocessorRegionContext(_localctx);
				this.enterOuterAlt(_localctx, 11);
				{
				this.state = 63;
				this.match(CSharpPreprocessorParserParser.ENDREGION);
				this.state = 65;
				this._errHandler.sync(this);
				_la = this._input.LA(1);
				if (_la === CSharpPreprocessorParserParser.TEXT) {
				...
				break;
			case CSharpPreprocessorParserParser.PRAGMA:
				_localctx = new PreprocessorPragmaContext(_localctx);
				this.enterOuterAlt(_localctx, 12);
				{
				this.state = 70;
				this.match(CSharpPreprocessorParserParser.PRAGMA);
				this.state = 71;
				this.match(CSharpPreprocessorParserParser.TEXT);
				this.state = 72;
				this.directive_new_line_or_sharp();
				...
				break;
			case CSharpPreprocessorParserParser.NULLABLE:
				_localctx = new PreprocessorNullableContext(_localctx);
				this.enterOuterAlt(_localctx, 13);
				{
				this.state = 75;
				this.match(CSharpPreprocessorParserParser.NULLABLE);
				this.state = 76;
				this.match(CSharpPreprocessorParserParser.TEXT);
				this.state = 77;
				this.directive_new_line_or_sharp();
	...
	public directive_new_line_or_sharp(): Directive_new_line_or_sharpContext {
		...
		this.enterRule(_localctx, 2, CSharpPreprocessorParserParser.RULE_directive_new_line_or_sharp);
		let _la: number;
		try {
			this.enterOuterAlt(_localctx, 1);
			{
			this.state = 82;
			_la = this._input.LA(1);
			if (!(_la === CSharpPreprocessorParserParser.EOF || _la === CSharpPreprocessorParserParser.DIRECTIVE_NEW_LINE)) {
	...
	public preprocessor_expression(_p?: number): Preprocessor_expressionContext {
		...
		this.enterRecursionRule(_localctx, 4, CSharpPreprocessorParserParser.RULE_preprocessor_expression, _p);
		try {
			let _alt: number;
			this.enterOuterAlt(_localctx, 1);
			{
			...
			this._errHandler.sync(this);
			switch (this._input.LA(1)) {
			case CSharpPreprocessorParserParser.TRUE:
				{
				this.state = 85;
				this.match(CSharpPreprocessorParserParser.TRUE);
				 this.OnPreprocessorExpressionTrue(); 
				}
				break;
			case CSharpPreprocessorParserParser.FALSE:
				{
				this.state = 87;
				this.match(CSharpPreprocessorParserParser.FALSE);
				 this.OnPreprocessorExpressionFalse(); 
				}
				break;
			case CSharpPreprocessorParserParser.CONDITIONAL_SYMBOL:
				{
				this.state = 89;
				this.match(CSharpPreprocessorParserParser.CONDITIONAL_SYMBOL);
				...
				break;
			case CSharpPreprocessorParserParser.OPEN_PARENS:
				{
				this.state = 91;
				this.match(CSharpPreprocessorParserParser.OPEN_PARENS);
				this.state = 92;
				_localctx._expr = this.preprocessor_expression(0);
				this.state = 93;
				this.match(CSharpPreprocessorParserParser.CLOSE_PARENS);
				 this.OnPreprocessorExpressionConditionalOpenParens(); 
				}
				break;
			case CSharpPreprocessorParserParser.BANG:
				{
				this.state = 96;
				this.match(CSharpPreprocessorParserParser.BANG);
				this.state = 97;
			...
			while (_alt !== 2 && _alt !== ATN.INVALID_ALT_NUMBER) {
				if (_alt === 1) {
					...
					case 1:
						...
						this.pushNewRecursionContext(_localctx, _startState, CSharpPreprocessorParserParser.RULE_preprocessor_expression);
						this.state = 102;
						if (!(this.precpred(this._ctx, 4))) {
							throw this.createFailedPredicateException("this.precpred(this._ctx, 4)");
						}
						this.state = 103;
						this.match(CSharpPreprocessorParserParser.OP_EQ);
						this.state = 104;
					...
					case 2:
						...
						this.state = 108;
						this.match(CSharpPreprocessorParserParser.OP_NE);
						this.state = 109;
					...
					case 3:
						...
						this.state = 113;
						this.match(CSharpPreprocessorParserParser.OP_AND);
						this.state = 114;
					...
					case 4:
						...
						this.state = 118;
						this.match(CSharpPreprocessorParserParser.OP_OR);
						this.state = 119;
	...
	public static get _ATN(): ATN {
		if (!CSharpPreprocessorParserParser.__ATN) {
			CSharpPreprocessorParserParser.__ATN = new ATNDeserializer().deserialize(Utils.toCharArray(CSharpPreprocessorParserParser._serializedATN));
		}

		return CSharpPreprocessorParserParser.__ATN;
	}
...
export class Preprocessor_directiveContext extends ParserRuleContext {
	...
	// @Override
	public get ruleIndex(): number { return CSharpPreprocessorParserParser.RULE_preprocessor_directive; }
...
export class PreprocessorDeclarationContext extends Preprocessor_directiveContext {
	public DEFINE(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.DEFINE, 0); }
	public CONDITIONAL_SYMBOL(): TerminalNode { return this.getToken(CSharpPreprocessorParserParser.CONDITIONAL_SYMBOL, 0); }
	public directive_new_line_or_sharp(): Directive_new_line_or_sharpContext {
		return this.getRuleContext(0, Directive_new_line_or_sharpContext);
	}
	public UNDEF(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.UNDEF, 0); }
...
export class PreprocessorConditionalContext extends Preprocessor_directiveContext {
	...
	public IF(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.IF, 0); }
	public directive_new_line_or_sharp(): Directive_new_line_or_sharpContext {
		return this.getRuleContext(0, Directive_new_line_or_sharpContext);
	}
	...
	public ELIF(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.ELIF, 0); }
	public ELSE(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.ELSE, 0); }
	public ENDIF(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.ENDIF, 0); }
	constructor(ctx: Preprocessor_directiveContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class PreprocessorLineContext extends Preprocessor_directiveContext {
	public LINE(): TerminalNode { return this.getToken(CSharpPreprocessorParserParser.LINE, 0); }
	public directive_new_line_or_sharp(): Directive_new_line_or_sharpContext {
		return this.getRuleContext(0, Directive_new_line_or_sharpContext);
	}
	public DIGITS(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.DIGITS, 0); }
	public DEFAULT(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.DEFAULT, 0); }
	public DIRECTIVE_HIDDEN(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.DIRECTIVE_HIDDEN, 0); }
	public STRING(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.STRING, 0); }
	constructor(ctx: Preprocessor_directiveContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class PreprocessorDiagnosticContext extends Preprocessor_directiveContext {
	public ERROR(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.ERROR, 0); }
	public TEXT(): TerminalNode { return this.getToken(CSharpPreprocessorParserParser.TEXT, 0); }
	public directive_new_line_or_sharp(): Directive_new_line_or_sharpContext {
		return this.getRuleContext(0, Directive_new_line_or_sharpContext);
	}
	public WARNING(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.WARNING, 0); }
	constructor(ctx: Preprocessor_directiveContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class PreprocessorRegionContext extends Preprocessor_directiveContext {
	public REGION(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.REGION, 0); }
	public directive_new_line_or_sharp(): Directive_new_line_or_sharpContext {
		return this.getRuleContext(0, Directive_new_line_or_sharpContext);
	}
	public TEXT(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.TEXT, 0); }
	public ENDREGION(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.ENDREGION, 0); }
	constructor(ctx: Preprocessor_directiveContext) {
		super(ctx.parent, ctx.invokingState);
		this.copyFrom(ctx);
	}
...
export class PreprocessorPragmaContext extends Preprocessor_directiveContext {
	public PRAGMA(): TerminalNode { return this.getToken(CSharpPreprocessorParserParser.PRAGMA, 0); }
	public TEXT(): TerminalNode { return this.getToken(CSharpPreprocessorParserParser.TEXT, 0); }
	public directive_new_line_or_sharp(): Directive_new_line_or_sharpContext {
		return this.getRuleContext(0, Directive_new_line_or_sharpContext);
	}
...
export class PreprocessorNullableContext extends Preprocessor_directiveContext {
	public NULLABLE(): TerminalNode { return this.getToken(CSharpPreprocessorParserParser.NULLABLE, 0); }
	public TEXT(): TerminalNode { return this.getToken(CSharpPreprocessorParserParser.TEXT, 0); }
	public directive_new_line_or_sharp(): Directive_new_line_or_sharpContext {
		return this.getRuleContext(0, Directive_new_line_or_sharpContext);
	}
...
export class Directive_new_line_or_sharpContext extends ParserRuleContext {
	public DIRECTIVE_NEW_LINE(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.DIRECTIVE_NEW_LINE, 0); }
	public EOF(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.EOF, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return CSharpPreprocessorParserParser.RULE_directive_new_line_or_sharp; }
	// @Override
	public enterRule(listener: CSharpPreprocessorParserListener): void {
...
export class Preprocessor_expressionContext extends ParserRuleContext {
	...
	public TRUE(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.TRUE, 0); }
	public FALSE(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.FALSE, 0); }
	public CONDITIONAL_SYMBOL(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.CONDITIONAL_SYMBOL, 0); }
	public OPEN_PARENS(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.OPEN_PARENS, 0); }
	public CLOSE_PARENS(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.CLOSE_PARENS, 0); }
	public preprocessor_expression(): Preprocessor_expressionContext[];
	...
	public BANG(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.BANG, 0); }
	public OP_EQ(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.OP_EQ, 0); }
	public OP_NE(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.OP_NE, 0); }
	public OP_AND(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.OP_AND, 0); }
	public OP_OR(): TerminalNode | undefined { return this.tryGetToken(CSharpPreprocessorParserParser.OP_OR, 0); }
	constructor(parent: ParserRuleContext | undefined, invokingState: number) {
		super(parent, invokingState);
	}
	// @Override
	public get ruleIndex(): number { return CSharpPreprocessorParserParser.RULE_preprocessor_expression; }
	// @Override
	public enterRule(listener: CSharpPreprocessorParserListener): void {
